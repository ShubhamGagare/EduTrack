...
export default async function LoginPage() {
  ...
  return (
    ...
    <div className="relative hidden justify-center h-full flex-col  bg-gradient-to-r from-violet-500 to-red-400 p-10 pb-10 text-violet-900 dark:border-r lg:flex items-center">
        
        <label className="text-8xl font-bold text-white">EduTrack</label>
        <label className="text-2xl  text-white">Empowering Educators with Smart AI Solutions</label>
    </div>
